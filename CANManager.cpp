...
//初期化関数
 ...
 bool FlexCAN_T4_manager::isinit(){
   return inited;
 }
 //mapテーブルクリア関数
...
//canbus存在チェック関数
bool FlexCAN_T4_manager::CAN1isOpen(){
  return can1busisopen;
}
bool FlexCAN_T4_manager::CAN2isOpen(){
  return can2busisopen;
}
bool FlexCAN_T4_manager::CAN3isOpen(){
  return can3busisopen;
}

//CAN受信データ途絶検知関数
bool FlexCAN_T4_manager::isNoCan1(){
  return flgNoCan1Data;
}
bool FlexCAN_T4_manager::isNoCan2(){
  return flgNoCan2Data;
}
bool FlexCAN_T4_manager::isNoCan3(){
  return flgNoCan3Data;
}
//緊急停止用関数
void FlexCAN_T4_manager::EmergencyStop(){
